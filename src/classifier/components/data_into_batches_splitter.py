...
class DataIntoBatchesSplitter:
    ...
    def load_data_and_split(self):
        # Doc dataset
        print(
            f"=========== Load dataset từ thư mục {self.config.folder_path} =============="
        )
        ...
        # Chia thanh 3 tap
        print("======= Chia dataset thành 3 tập train, val, test ===============")
        ...
        print("======= Cache và prefetch 3 tập train, val, test ===============")
        ...
        # Lưu dữ liệu
        print(
            f"=========== Lưu 3 tập train, val, test vào thư mục {self.config.root_dir} ============"
        )
